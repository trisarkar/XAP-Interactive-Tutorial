...
try {
    ...
    //Initialize SQLQuery
    print_color "|GREEN|Press ENTER to initialize SQLQuery to get Person objects with criteria: |BLUE|country=\"UK\" OR country=\"U.S.A\"|CLEAR|"
    br.readLine()
    ...
    print_color("|YELLOW|* Using MultiplyLongChangeOperation custom change operation, we will multiple the value stored in the field \"age\"|CLEAR|")
    println ""
